...
Java_xyz_omkar_tokenizers_Tokenizer_newTokenizer(JNIEnv *env, jobject thiz, jstring config) {
...
Java_xyz_omkar_tokenizers_Tokenizer_encode(JNIEnv *env, jobject thiz, jlong native_ptr,
                                           jstring sequence, jboolean add_special_tokens) {
...
Java_xyz_omkar_tokenizers_Tokenizer_decode(JNIEnv *env, jobject thiz, jlong native_ptr,
                                           jintArray ids, jboolean skip_special_tokens) {
    Tokenizer *tokenizer = reinterpret_cast<Tokenizer *>(native_ptr);

...
Java_xyz_omkar_tokenizers_cpp_Tokenizer_newTokenizer(JNIEnv *env, jobject thiz,
                                                     jstring config) {
...
Java_xyz_omkar_tokenizers_cpp_Tokenizer_encode(JNIEnv *env, jobject thiz,
                                               jlong native_ptr,
                                               jstring sequence,
...
Java_xyz_omkar_tokenizers_cpp_Tokenizer_decode(JNIEnv *env, jobject thiz,
                                               jlong native_ptr, jintArray ids,
